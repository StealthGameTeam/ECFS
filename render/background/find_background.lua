...
bgs["bus"]   =  {img = love.graphics.newImage("assets/backgrounds/busstop1.PNG"), x = 0, y = -100, r=0, sx = 1.3, sy = 1}
bgs["library"]   =  {img = love.graphics.newImage("assets/backgrounds/library2.PNG"), x = 0, y = 0, r=0, sx = 0.9, sy = 0.9}
