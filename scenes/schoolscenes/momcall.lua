...
local wifu = core.PreFill(helpers.add_like, "mom")
...
S("1", {location = "school",  text = "Me: Hello mom.", girl = "mom", choices = ch})
...
S("3A", {location = "school",  text = "I told you ten times already.", girl = "mom", choices = ch})
local ch = {}
A(ch, {text = "...",
	requirements = {},
	consequence = helpers.change_state("4")})
S("3B", {location = "school",  text = "... That's good.", girl = "mom", choices = ch})
...
S("5A", {location = "school",  text = "Then don't come to dinner unless you have one.", girl = "mom", choices = ch})
local ch = {}
A(ch, {text = "...",
	requirements = {},
	consequence = helpers.change_state("6")})
S("5B", {location = "school",  text = "Somehow I don't believe that.", girl = "mom", choices = ch})
local ch = {}
A(ch, {text = "...",
	requirements = {},
	consequence = helpers.change_state("6")})
S("5C", {location = "school",  text = "Finally, we've all been waiting to meet her for quite a while.", girl = "mom", choices = ch})
...
S("7", {location = "school",  text = "Good, I'll speak to you later then.", girl = "mom", choices = ch})
...
A(ch, {text = "Yes Mom, bye.",
	requirements = {},
	consequence = POPBACK})
S("8", {location = "school",  text = "Bye now; Don't forget to eat breakfast..", girl = "mom", choices = ch})
...
S("9", {location = "school",  text = "That was an awkward call.. Well, it seems I have to find a girlfriend in a week. But how do I find one? I daren't even approach girls..", girl = "mom", choices = ch})
